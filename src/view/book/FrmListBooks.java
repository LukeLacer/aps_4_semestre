 ...
 * @author lucas
 */
public class FrmListBooks extends javax.swing.JFrame {
    CtrBooks ctrBook;
    Book book;
    /**
     * Creates new form FrmListBooks
     */
    public FrmListBooks() {
        initComponents();
    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        if (listBook != null && !listBook.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(null, "Nenhum Livro disponível para listar!!");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmListBooks.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmListBooks().setVisible(true);
            }
        });
    }
